        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OtherStatus = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Salary = table.Column<int>(type: "int", nullable: true),
                    CVurl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WillBeContacted = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientCandidates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClientCandidates_Candidates_CandidateId",
                        column: x => x.CandidateId,
                        principalTable: "Candidates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientCandidates_Clients_ClientId",
                        column: x => x.ClientId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientCandidates_CandidateId",
                table: "ClientCandidates",
                column: "CandidateId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientCandidates_ClientId",
                table: "ClientCandidates",
                column: "ClientId");
